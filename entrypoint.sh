#!/bin/bash
echo "entrypoint.sh version 20260317"

#set -eu
#set -v

for v in http_proxy https_proxy no_proxy HTTP_PROXY HTTPS_PROXY NO_PROXY TZ
do
...
# Add code to ~/.bashrc to add ~/bin and ~/.local/bin to PATH
...
# Workaround for libEGL warning on first Gazebo launch
